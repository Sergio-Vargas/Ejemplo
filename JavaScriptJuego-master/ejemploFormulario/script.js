...
const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "¡Perdiste!",
                    html: `
                <img class="img-fluid" src="perdiste.jpg" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="ganaste.png" alt="Ganaste">
